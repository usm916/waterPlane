...
void WaterPlane::setupGUI()
{
    ...
    ofAddListener( gui->newGUIEvent, this, &WaterPlane::guiEvent);
}

void WaterPlane::guiEvent(ofxUIEventArgs &e)
{
...
//--------------------------------------------------------------
void WaterPlane::keyPressed(int key)
{
    switch (key)
    {
        case 'h':
...
//--------------------------------------------------------------
void WaterPlane::keyReleased(int key){
    
}

//--------------------------------------------------------------
void WaterPlane::mouseMoved(int x, int y ){
    
}

//--------------------------------------------------------------
void WaterPlane::mouseDragged(int x, int y, int button){
...
//--------------------------------------------------------------
void WaterPlane::mousePressed(int x, int y, int button){
    float adjustWidth = 50;
    float sWidth = width + 100;
...
//--------------------------------------------------------------
void WaterPlane::mouseReleased(int x, int y, int button){
}

//--------------------------------------------------------------
void WaterPlane::windowResized(int w, int h){
    changeWindow();
}

//--------------------------------------------------------------
void WaterPlane::gotMessage(ofMessage msg){
    
}

//--------------------------------------------------------------
void WaterPlane::dragEvent(ofDragInfo dragInfo){
    
}

void WaterPlane::ripple(float mx, float my, float intensity){
    float dx, dy, acc;
...
void WaterPlane::updateWaterSurface()
{
    // ---Water simulation---
...
void WaterPlane::transformVertices()
{
    float iz;
    ofVec3f* v;
    int i;
